            ...
            <div className="row g-0">
              ...
              <div className="px-4 ">
                ...
                {messages.map((message) =>
                  <Link 
                    to={"/messagedetails/" + (message.sender.id === user_id ? message.reciever.id : message.sender.id) + "/"}
                    href="#"
                  ...
                  >
                    ...
                    {message.sender.id !== user_id && message.sender_profile?.photo && (
                    <img src={message.sender_profile.photo} className="rounded-circle mr-1" alt="1" width={40} height={40}/>
                    )}
                    {message.sender.id === user_id && message.reciever_profile?.photo && (
